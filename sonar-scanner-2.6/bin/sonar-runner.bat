...
IF EXIST "%SONAR_RUNNER_HOME%\lib\sonar-scanner-cli-2.6.jar" goto sonarRunnerOpts
...
%JAVA_EXEC% -Djava.awt.headless=true %SONAR_SCANNER_OPTS% -cp "%SONAR_RUNNER_HOME%\lib\sonar-scanner-cli-2.6.jar" "-Dscanner.home=%SONAR_RUNNER_HOME%" "-Dproject.home=%PROJECT_HOME%" org.sonarsource.scanner.cli.Main %*
