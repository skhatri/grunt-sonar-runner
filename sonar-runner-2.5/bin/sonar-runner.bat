...
IF EXIST "%SONAR_RUNNER_HOME%\lib\sonar-runner-dist-2.5-RC1.jar" goto run
...
%JAVA_EXEC% %SONAR_RUNNER_OPTS% -cp "%SONAR_RUNNER_HOME%\lib\sonar-runner-dist-2.5-RC1.jar" "-Drunner.home=%SONAR_RUNNER_HOME%" "-Dproject.home=%PROJECT_HOME%" org.sonar.runner.Main %*
